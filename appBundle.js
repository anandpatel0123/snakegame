...
var APP_com_snakegame_com = (function () {
  ...
  class App extends Lightning$1.Component {
    ...
    static _template() {
      return {
        RoundRectangle: {
          w: 1920,
          h: 1080,
          texture: Lightning$1.Tools.getRoundRect(1920, 1080, 0, 20, 0xffb967ff, true, 0xff284b4b)
        },
        Snake: {
          x: 300,
          y: 300,
    ...
    _handleLeft() {
      if (this._snakeDirection.x != 1) this._snakeDirection = {
        x: -1,
        y: 0
      };
    }
    ...
    _handleUp() {
      if (this._snakeDirection.y != 1) this._snakeDirection = {
        x: 0,
        y: -1
      };
    }
    _checkCollision() {
      if (Math.abs(this._snakeX - this._foodX + 300) <= 20 && Math.abs(this._snakeY - this._foodY + 300) <= 20) {
        this._eatFood();
      }
      if (this._snakeX < -300 || this._snakeX >= 1880 - 300 || this._snakeY < -300 || this._snakeY >= 1040 - 300) {
        this._endGame();
      }
    }
    _checkSelfCollision() {
    ...
    _eatFood() {
      this._snakeTail.push({
        x: this._snakeX,
        y: this._snakeY
      });
      this._createFood();
      this._score += 1;
      this.tag("Score").text.text = "Score: ".concat(this._score);
    }
    _updateSnake() {
      const tailSegment = {
        x: this._snakeX,
    ...
    _endGame() {
      ...
      this.tag("MyScore").text.text = "Score: ".concat(this._score);
    }
  }
